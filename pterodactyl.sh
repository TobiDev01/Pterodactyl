...
summary() {
  #clear
  echo ""
  echo -e "\033[1;93mDatabase credentials:\033[0m"
  echo "\033[1;92m*\033[0m Name: panel"
  echo "\033[1;92m*\033[0m IPv4: 127.0.0.1"
  echo "\033[1;92m*\033[0m Port: 3306"
  echo "\033[1;92m*\033[0m User: pterodactyl"
  echo "\033[1;92m*\033[0m Password: $MYSQL_PASSWORD"
  echo ""
  echo -e "\033[1;94mPanel credentials:\033[0m"
  echo "\033[1;92m*\033[0m Email: $email"
  echo "\033[1;92m*\033[0m Username: $user_username"
  echo "\033[1;92m*\033[0m Password: $user_password"
  echo ""
